...
class Manga_Press_Setup {
    ...
    function set_default_options() {
        ...
        $mp_options = array(
            'basic' => array(
                'order_by'            => 'post_date',
                'group_comics'        => false, // New options in 3.0
                'latestcomic_page'    => 0,
                'comicarchive_page'   => 0,                
            ),
            'comic_page' => array(
                ...
                'banner_width'        => 420,
                'banner_height'       => 100,
                'comic_post_count'    => 10, // New option in 3.0
                'generate_comic_page' => false, // New option in 3.0
                'comic_page_width'    => 600, // New option in 3.0
                'comic_page_height'   => 1000, // New option in 3.0                
            ),
            'nav' => array(
                'nav_css'    => 'default_css',                
                'insert_nav' => false,
