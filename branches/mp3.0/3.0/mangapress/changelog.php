 ...
 * 2.7		-	Eliminated the need for wp_comic_last, wp_comic_first, wp_comic_previous, and wp_comic_next. To save on database calls
 				comic navigation is now created using get_posts()
 *
 */
?>