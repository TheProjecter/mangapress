...
class WP_ComicPost {
     ...
     */
    public function  __construct($_post, $file, $_post_type = 'post')
    {
        ...
        $this->post_content   = ($_post_type == 'post')
                              ? $this->get_comicpage_html($file)
                              : "Attachment for ".$_post['title'];
    ...
    private function get_comicpage_html($image, $excerpt = false)
    {
        ...
        $html = '<img src="'
              . $image['url'] . '" '
              . $attr
              . ' class="aligncenter size-full comic-page" alt="[image]" />';
