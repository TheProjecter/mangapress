 ...
 * 2.0.1-beta   -	Corrected a minor bug in update_options. Banner skin wouldn't be uploaded even if "use banner skin" option
 ...
 * 2.6.2        -       Spanish language support added.
 * 2.7          -
 */
